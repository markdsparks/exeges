...
function formatSourceFinding(finding) {
    return {
        ...
        license: finding.license || finding.source?.license || '',
        licenseUrl: finding.licenseUrl || finding.source?.licenseHref || '',
        attribution: finding.attribution || finding.source?.attribution || '',
        sourceUrl: finding.sourceUrl || finding.source?.href || '',
        confidence: finding.confidence ?? '',
        reviewStatus: finding.reviewStatus ?? '',
        allowedUse: finding.allowedUse ?? '',
...
function formatEvidenceCard(finding) {
    return {
        ...
        allowedUse: finding.allowedUse || getAllowedUse(finding),
        claim: finding.text,
    };
}
